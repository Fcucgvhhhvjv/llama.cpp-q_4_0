...
// usage:
//  ./update-rwkv models/llama/ggml-model-input.bin models/llama/ggml-model-output.bin
...
// Also, if modified locally (along with rwkv.cpp), you can use this to add or remove hparams, score, etc from a model. For instance, I used this to open a model in ggjt (no score) and saved it again as ggjt (with score).
//
int main(int argc, char ** argv) {
    ...
    rwkv_model_update(fname_inp.c_str(), fname_out.c_str());
