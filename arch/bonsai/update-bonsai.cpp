...
// usage:
//  ./update-bonsai models/llama/ggml-model-input.bin models/llama/ggml-model-output.bin
...
// Also, if modified locally (along with bonsai.cpp), you can use this to add or remove hparams, score, etc from a model. For instance, I used this to open a model in ggjt (no score) and saved it again as ggjt (with score).
//
int main(int argc, char ** argv) {
    ...
    bonsai_model_update(fname_inp.c_str(), fname_out.c_str());
